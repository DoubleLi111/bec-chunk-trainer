...
const prenupChunks: Chunk[] = [
  {
    ...
    chinese: "婚前协议",
    ipa: "prenup /ˈpriːnʌp/ · prenuptial /ˌpriːˈnʌpʃəl/",
  ...
  },
  {
    ...
    chinese: "触发条款",
    ipa: "trigger /ˈtrɪɡə/ · clause /klɔːz/",
  ...
  },
  {
    ...
    chinese: "可怕的婚姻经历",
    ipa: "marital /ˈmærɪtəl/ · horror /ˈhɒrə/",
  ...
  },
  {
    ...
    chinese: "精心起草协议",
    ipa: "craft /krɑːft/ · agreement /əˈɡriːmənt/",
  ...
  },
  {
    ...
    chinese: "一次财务规划实践",
    ipa: "financial /faɪˈnænʃəl/ · exercise /ˈeksəsaɪz/",
  ...
  },
  {
    ...
    chinese: "向投资账户存款",
    ipa: "contribute /kənˈtrɪbjuːt/ · investment /ɪnˈvestmənt/",
...
const assaultNewsChunks: Chunk[] = [
  {
    id: 219,
    english: "be arrested on suspicion of…",
    chinese: "因涉嫌……而被捕",
    ipa: "arrested /əˈrestɪd/ · suspicion /səˈspɪʃən/",
    note: "新闻和法律报道中的常见客观表述，of 后接名词或动名词。",
    example: "Two senior employees were arrested on suspicion of misconduct.",
    audioText: "be arrested on suspicion of",
  },
  {
    id: 220,
    english: "allegedly do something",
    chinese: "据称或涉嫌做某事",
    ipa: "allegedly /əˈledʒɪdli/",
    note: "在事实尚未由法院认定时保持新闻表述的审慎与客观。",
    example: "The manager allegedly used his position to pressure an employee.",
  },
  {
    id: 221,
    english: "a local government official",
    chinese: "地方政府官员",
    ipa: "official /əˈfɪʃəl/",
    note: "official 作名词时指官员，也可作形容词表示正式的或官方的。",
    example: "A local government official promised a transparent investigation.",
  },
  {
    id: 222,
    english: "a state-owned enterprise executive",
    chinese: "国有企业高管",
    ipa: "enterprise /ˈentəpraɪz/ · executive /ɪɡˈzekjətɪv/",
    note: "BEC和商业新闻中的高频组织身份表达。",
    example: "A state-owned enterprise executive attended the business gathering.",
  },
  {
    id: 223,
    english: "at a business gathering",
    chinese: "在商务聚会中",
    ipa: "gathering /ˈɡæðərɪŋ/",
    note: "比 party 正式，可泛指商务宴请、酒会或社交活动。",
    example: "Employees should feel safe and respected at a business gathering.",
  },
  {
    id: 224,
    english: "following an official dinner",
    chinese: "在正式宴请之后",
    ipa: "following /ˈfɒləʊɪŋ/ · official /əˈfɪʃəl/",
    note: "following 在新闻和书面语中可作介词，表示“在……之后”。",
    example: "The discussion continued following an official dinner.",
  },
  {
    id: 225,
    english: "leave somebody injured",
    chinese: "导致某人受伤",
    ipa: "injured /ˈɪndʒəd/",
    note: "leave somebody + 形容词表示使某人处于某种状态。",
    example: "The incident left one employee injured and deeply distressed.",
  },
  {
    id: 226,
    english: "be dismissed from one’s position",
    chinese: "被免去职务",
    ipa: "dismissed /dɪsˈmɪst/ · position /pəˈzɪʃən/",
    note: "适合正式职场和新闻语境；dismiss 也可表示解雇。",
    example: "Both suspects were dismissed from their positions after the investigation.",
  },
  {
    id: 227,
    english: "spark widespread public outrage",
    chinese: "引发广泛公愤",
    ipa: "widespread /ˈwaɪdspred/ · outrage /ˈaʊtreɪdʒ/",
    note: "spark 强调某事迅速触发一种强烈的社会反应。",
    example: "The reported abuse of power sparked widespread public outrage.",
  },
  {
    id: 228,
    english: "fuel public anger",
    chinese: "加剧公众愤怒",
    ipa: "fuel /ˈfjuːəl/ · anger /ˈæŋɡə/",
    note: "fuel 作动词表示助长或加剧，后面可接 anger、concern、debate 等。",
    example: "The lack of transparency may fuel public anger.",
  },
  {
    id: 229,
    english: "an abuse of power",
    chinese: "权力滥用",
    ipa: "abuse /əˈbjuːs/",
    note: "此处 abuse 是名词，重音在第二音节；常用于讨论职权或地位的滥用。",
    example: "Companies need clear procedures to prevent an abuse of power.",
  },
  {
    id: 230,
    english: "a workplace hierarchy",
    chinese: "职场层级制度",
    ipa: "hierarchy /ˈhaɪərɑːki/",
    note: "适用于讨论权力距离、上下级关系和组织文化。",
    example: "A rigid workplace hierarchy can make junior employees afraid to speak up.",
  },
  {
    id: 231,
    english: "trend heavily on social media",
    chinese: "在社交媒体上引发热议",
    ipa: "heavily /ˈhevɪli/ · media /ˈmiːdiə/",
    note: "用于描述某个话题在网络平台上获得大量关注。",
    example: "The case trended heavily on social media for several days.",
  },
  {
    id: 232,
    english: "generate even more attention",
    chinese: "引发更多关注",
    ipa: "generate /ˈdʒenəreɪt/ · attention /əˈtenʃən/",
    note: "generate attention 是雅思写作和商业传播中的常用搭配。",
    example: "The official statement generated even more attention online.",
  },
  {
    id: 233,
    english: "consent to do something",
    chinese: "同意或自愿做某事",
    ipa: "consent /kənˈsent/",
    note: "正式程度高于 agree；强调在知情且自愿的情况下作出同意。",
    example: "Attending a gathering does not mean consenting to inappropriate behaviour.",
  },
  {
    id: 234,
    english: "the rationale behind…",
    chinese: "……背后的理由或逻辑",
    ipa: "rationale /ˌræʃəˈnɑːl/",
    note: "适合雅思口语论证和BEC会议讨论，用来追问决策依据。",
    example: "What is the rationale behind requiring employees to attend late-night dinners?",
    audioText: "the rationale behind",
  },
  {
    id: 235,
    english: "call for an end to…",
    chinese: "呼吁终止……",
    ipa: "call /kɔːl/",
    note: "新闻和雅思写作高频表达，to 后接名词或动名词。",
    example: "Many people called for an end to toxic workplace drinking practices.",
    audioText: "call for an end to",
  },
  {
    id: 236,
    english: "deal with the individuals involved",
    chinese: "处理相关涉事人员",
    ipa: "individuals /ˌɪndɪˈvɪdʒuəlz/ · involved /ɪnˈvɒlvd/",
    note: "deal with 可表示处理问题或采取措施处置相关人员。",
    example: "It is not enough to deal only with the individuals involved.",
  },
  {
    id: 237,
    english: "define the boundaries of…",
    chinese: "明确……的边界",
    ipa: "define /dɪˈfaɪn/ · boundaries /ˈbaʊndəriz/",
    note: "适用于讨论职场规范、职责范围和人际界限。",
    example: "Employers should define the boundaries of acceptable business interactions.",
    audioText: "define the boundaries of",
  },
  {
    id: 238,
    english: "through institutional measures",
    chinese: "通过制度性措施",
    ipa: "institutional /ˌɪnstɪˈtjuːʃənəl/ · measures /ˈmeʒəz/",
    note: "雅思写作中用于从制度层面提出解决方案。",
    example: "Workplace misconduct should be prevented through institutional measures.",
  },
  {
    id: 239,
    english: "be not unheard of",
    chinese: "并非没有发生过；并不罕见",
    ipa: "unheard /ˌʌnˈhɜːd/",
    note: "双重否定式表达，语气比 common 更谨慎。",
    example: "Pressure to drink at corporate events is not unheard of.",
  },
  {
    id: 240,
    english: "feel pressured to drink",
    chinese: "感到被迫喝酒",
    ipa: "pressured /ˈpreʃəd/",
    note: "比 be forced to drink 更委婉自然，也更适合日常和雅思口语。",
    example: "No employee should feel pressured to drink in order to fit in.",
  },
  {
    id: 241,
    english: "a male-dominated society",
    chinese: "男性占主导地位的社会",
    ipa: "male-dominated /ˌmeɪl ˈdɒmɪneɪtɪd/ · society /səˈsaɪəti/",
    note: "正式英语通常使用 male-dominated，而不是 man-dominated。",
    example: "Traditional drinking customs may reflect the norms of a male-dominated society.",
  },
];

const assaultNewsSentences: Sentence[] = [
  {
    chinese: "这起事件引发广泛公愤，并进一步加剧了公众对权力滥用的愤怒。",
    parts: ["The incident", "sparked widespread public outrage", "and further", "fuelled public anger over the abuse of power."],
  },
  {
    chinese: "严格的职场层级可能使员工感到被迫参加酒局并喝酒。",
    parts: ["A rigid workplace hierarchy", "may make employees", "feel pressured to attend gatherings", "and drink alcohol."],
  },
  {
    chinese: "参加商务聚会并不意味着同意受到不当对待。",
    parts: ["Attending", "a business gathering", "does not mean", "consenting to inappropriate treatment."],
  },
  {
    chinese: "仅仅处理相关涉事人员并不足以解决这个问题。",
    parts: ["It is not enough", "to deal only with", "the individuals", "involved."],
  },
  {
    chinese: "企业应当通过制度性措施明确商务交往的边界。",
    parts: ["Companies should", "define the boundaries", "of business interactions", "through institutional measures."],
  },
  {
    chinese: "许多人呼吁终止有害的职场酒桌文化。",
    parts: ["Many people", "have called for an end to", "toxic workplace", "drinking culture."],
  },
];
...
const contentLibrary = defineLibrary([
  ...
  },
  {
    ...
    units: [
      ...
      {
        id: "news-sexual-assault",
        category: "News",
        name: "性侵",
        section: "Workplace power & drinking culture",
        chunks: assaultNewsChunks,
        sentences: assaultNewsSentences,
        scenario: {
          label: "IELTS SPEAKING · BEC DISCUSSION",
          question: "How can organisations prevent the abuse of power at business gatherings?",
          prompt: "尝试使用 workplace hierarchy、feel pressured to drink、define the boundaries of 和 institutional measures。",
          placeholder: "Organisations should make it clear that...",
          reference: "Organisations should define the boundaries of acceptable business interactions through institutional measures. A rigid workplace hierarchy must not make employees feel pressured to drink, and complaints about an abuse of power should be investigated independently.",
        },
      },
    ],
  },
              ...
              <button className={`flashcard ${revealed ? "revealed" : ""}`} onClick={() => setRevealed(true)}>
                ...
                {!revealed ? (
                  ...
                  <div className="answer-panel">
                    ...
                    {currentCard.ipa && <p className="chunk-ipa">{currentCard.ipa}</p>}
